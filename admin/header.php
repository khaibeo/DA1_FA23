        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>
                        <a  href="index.php?act=list_category">List Category</a>
                    </li>
                </ul>
            </li>
            <!-- <li>
            ...
            <li>
                ...
                <ul>
                    <li>
                        <a  href="index.php?act=add_product">Add Products</a>
                    </li>
                    <li>
                        <a  href="index.php?act=list_product">List Products</a>
                    </li>
                </ul>
            </li>
            <li>
            ...
            <li>
                ...
                <ul>
                    <li><a  href="index.php?act=list_account">List Account</a></li
                </ul>
            </li>
            <li>
                <a href="#">
