				...
				<div class="row small-gutters">
					...
					<nav class="col-xl-6 col-lg-7">
						...
						<div class="main-menu" style="text-align:center;">
							...
							<ul>
								<li class="submenu">
									<a href="../admin/index.php" class="show-submenu">Home</a>
									<!-- <ul>
								...
								<li class="megamenu submenu">
									...
									<div class="menu-wrapper">
										<div class="row small-gutters">
											<div class="col-lg-3">
												<h3><a href="">Quản Lý Danh Mục</a></h3>
											</div>
											<div class="col-lg-3">
												<h3><a href="">Quản Lý Sản Phẩm</a></h3>
											</div>
											<div class="col-lg-3">
												<h3><a href="">Quản Lý Tài Khoản</a></h3>
											</div>
											<div class="col-lg-3">
												<h3><a href="">Quản Lý Ảnh</a></h3>
											</div>
											<div class="col-lg-3">
												<h3><a href="">Quản Lý Bill</a></h3>
											</div>
											<div class="col-lg-3">
												<h3><a href="">Thống Kê Sản Phẩm Theo Tháng</a></h3>
											</div>
											<div class="col-lg-3">
												<h3><a href="">Thống Sản Phẩm Theo Danh Mục</a></h3>
											</div>
											<div class="col-lg-3 d-xl-block d-lg-block d-md-none d-sm-none d-none">
												<div class="banner_menu">
													<a href="#0">
														<img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="img/banner_menu.jpg" width="100%" height="250" alt="" class="img-fluid lazy">
													</a>
												</div>
											</div>
										</div>
