...
<!-- Mirrored from vetra.laborasyon.com/demos/default/email.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Nov 2023 15:04:36 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title> Inbox - Vetra | E-Commerce HTML Admin Dashboard Template </title>
    ...
    <div class="row">
        <div class="col-lg-9">
            ...
            <div class="email-list">
                <ul class="list-group">
                    <li class="list-group-item text-success" data-detail-url="email-detail.html">
                        <div class="flex-shrink-0">
                    ...
                    <li class="list-group-item" data-detail-url="email-detail.html">
                        <div class="flex-shrink-0">
                            <input class="form-check-input me-3" type="checkbox">
                        </div>
                        <div class="d-none d-sm-block flex-shrink-0">
...
<script src="./libs/bundle.js"></script>
    ...
    <script src="./dist/js/examples/tagsinput.js"></script>

    <!-- Quill -->
    <script src="./libs/quill/quill.js"></script>

    <!-- App example codes -->
    <script src="./dist/js/examples/mail.js"></script>
...
<!-- Mirrored from vetra.laborasyon.com/demos/default/email.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Nov 2023 15:04:39 GMT -->
</html>
